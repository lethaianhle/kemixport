...
const translations = {
    vi: {
        ...
        'about.counter1': 'Khách hàng',
        'about.counter2': 'Dự án thành công',
    ...
    en: {
        ...
        'banner.title': 'Clean Charcoal from Vietnamese Craft <br> Villages - Your Global Partner',
        ...
        'about.title': 'The Difference <br> Creates Leading Position',
        'about.desc1': 'Proactive Supply & Price - 100% sawdust control from craft villages, ensuring 800-1,500 tons/month and competitive base price. 15 Years of Experience - We are masters in clean charcoal production technology, ensuring consistent quality, no mixing, and meeting strict requirements from Middle East BBQ to European heating.',
        'about.desc2': 'On-time Delivery: Large scale, optimized process, committed schedule for every order.',
        'about.counter1': 'Customers',
        'about.counter2': 'Successful Projects',
